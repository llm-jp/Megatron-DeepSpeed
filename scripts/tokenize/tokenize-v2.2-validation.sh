...
INPUT_DIR=/bb/llm/gaf51275/llm-jp/datasets/llm-jp-corpus/v1.0.2/sample/

# set the output directory
OUTPUT_DIR=/bb/llm/gaf51275/llm-jp/datasets/binarized/v1.0.2/code20K_en40K_ja60K.ver2.2/validation
mkdir -p $OUTPUT_DIR
...
MERGED_FILE_PATH="$MERGED_FILE_DIR/validation.jsonl"
...
for file in $INPUT_DIR/*/*validation*; do
  if [ -f "$file" ]; then
...
python tools/preprocess_data.py \
  ...
  --output-prefix $OUTPUT_DIR/validation \
